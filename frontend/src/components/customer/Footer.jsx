            ...
            <div className="lg:col-span-2">
              <Link href="/" className="inline-block mb-4 focus:outline-none focus:ring-2 focus:ring-primary-500 rounded">
                <Image
                  ...
                  unoptimized
                />
                <span className="font-playfair text-2xl font-bold bg-gradient-to-r from-primary-400 to-purple-400 bg-clip-text text-transparent">
                  LaraibCreative
                </span>
              </Link>
          ...
          <div className="mt-12 pt-8 border-t border-gray-800">
            <div className="max-w-md">
              ...
              <form className="space-y-3" onSubmit={handleSubscribe}>
                ...
                {subscriptionStatus && (
                  <p className={`text-sm ${subscriptionStatus.type === 'success' ? 'text-green-400' : 'text-red-400'
                    }`} role="alert">
