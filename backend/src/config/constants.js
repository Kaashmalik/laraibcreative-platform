...
const ORDER_STATUS = {
  ...
  FABRIC_ARRANGED: 'fabric-arranged',
...
const ORDER_STATUS_LABELS = {
  ...
  [ORDER_STATUS.FABRIC_ARRANGED]: 'Fabric Arranged',
  [ORDER_STATUS.STITCHING_IN_PROGRESS]: 'Stitching in Progress',
...
const ORDER_STATUS_WORKFLOW = {
  ...
  [ORDER_STATUS.PAYMENT_VERIFIED]: [ORDER_STATUS.FABRIC_ARRANGED, ORDER_STATUS.CANCELLED],
  [ORDER_STATUS.FABRIC_ARRANGED]: [ORDER_STATUS.STITCHING_IN_PROGRESS, ORDER_STATUS.CANCELLED],
  [ORDER_STATUS.STITCHING_IN_PROGRESS]: [ORDER_STATUS.QUALITY_CHECK],
  [ORDER_STATUS.QUALITY_CHECK]: [ORDER_STATUS.READY_FOR_DISPATCH, ORDER_STATUS.STITCHING_IN_PROGRESS],
  [ORDER_STATUS.READY_FOR_DISPATCH]: [ORDER_STATUS.OUT_FOR_DELIVERY],
